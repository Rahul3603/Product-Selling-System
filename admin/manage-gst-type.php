...
if (isset($_POST['submit'])) {
	$perc = get_safe_value($_POST['perc']);
	...
	if (mysqli_query($con, "update $table_name set perc='$perc',added_on='$added_on' where id='$id'")) {
		echo "<script>
					...
					<form method="post" autocomplete="off">
						<div class="card">
							...
							<div class="card-body">
								<div class="row">
									<?php
									input_col_lg_4_with_val('perc', 'Percentage', $perc);
									?>
								</div>
